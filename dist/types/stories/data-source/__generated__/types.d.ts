...
/** Event types */
export declare enum BusEventType {
...
export declare enum DataSourceSpecStatus {
...
export declare enum DispatchMetric {
...
export declare enum LedgerEntryField {
...
export declare enum LiquidityProvisionStatus {
...
export declare enum NodeSignatureKind {
...
export declare enum ProposalRejectionReason {
...
export declare enum ProtocolUpgradeProposalStatus {
...
export declare enum StakeLinkingStatus {
...
export declare enum StakeLinkingType {
