 ...
 */
export declare const AreaChart: <A>({ data, annotations, interactive, notEnoughDataText, priceFormat, theme, tooltip, xFormat, }: AreaChartProps<A>) => import("react/jsx-runtime").JSX.Element;
